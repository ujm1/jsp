...
const sinon_1 = require("../helpers/sinon");
/**
...
exports.rule = {
    create(context) {
        ...
        return {
            ...
            'Program:exit': () => {
                if (helpers_1.Chai.isImported(context) || sinon_1.Sinon.isImported(context)) {
...
class TestCaseAssertionVisitor {
    ...
    visit(context, node, visitedNodes) {
        ...
        if (helpers_1.Chai.isAssertion(context, node) || sinon_1.Sinon.isAssertion(context, node)) {
